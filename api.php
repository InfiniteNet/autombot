...
{
    /**
     * links endpoits consulta (GET)
     * 
     * https://infinitenet.net/autombot/api.php/records/agendamentos/?filter=user_code,eq,user_id
     * https://infinitenet.net/autombot/api.php/records/services/?filter=user_code,eq,user_id
     * para aplicar multiplos filtros
     * https://infinitenet.net/autombot/api.php/records/database/?filter=user_code,eq,ideunico&filter=day,eq,consulta
     * 
     */
...
// file: src/Autombot/MinhaAPI/Cache/Base/BaseCache.php
namespace Autombot\MinhaAPI\Cache\Base {

    use Autombot\MinhaAPI\Cache\Cache;
...
// file: src/Autombot/MinhaAPI/Cache/Cache.php
namespace Autombot\MinhaAPI\Cache {
...
// file: src/Autombot/MinhaAPI/Cache/CacheFactory.php
namespace Autombot\MinhaAPI\Cache {
...
// file: src/Autombot/MinhaAPI/Cache/MemcacheCache.php
namespace Autombot\MinhaAPI\Cache {

    use Autombot\MinhaAPI\Cache\Base\BaseCache;
...
// file: src/Autombot/MinhaAPI/Cache/MemcachedCache.php
namespace Autombot\MinhaAPI\Cache {
...
// file: src/Autombot/MinhaAPI/Cache/NoCache.php
namespace Autombot\MinhaAPI\Cache {
...
// file: src/Autombot/MinhaAPI/Cache/RedisCache.php
namespace Autombot\MinhaAPI\Cache {
...
// file: src/Autombot/MinhaAPI/Cache/TempFileCache.php
namespace Autombot\MinhaAPI\Cache {
...
// file: src/Autombot/MinhaAPI/Column/Reflection/ReflectedColumn.php
namespace Autombot\MinhaAPI\Column\Reflection {

    use Autombot\MinhaAPI\Database\GenericReflection;
...
// file: src/Autombot/MinhaAPI/Column/Reflection/ReflectedDatabase.php
namespace Autombot\MinhaAPI\Column\Reflection {
...
// file: src/Autombot/MinhaAPI/Column/DefinitionService.php
namespace Autombot\MinhaAPI\Column {

    use Autombot\MinhaAPI\Column\Reflection\ReflectedColumn;
    use Autombot\MinhaAPI\Column\Reflection\ReflectedTable;
    use Autombot\MinhaAPI\Database\GenericDB;
...
// file: src/Autombot/MinhaAPI/Column/ReflectionService.php
namespace Autombot\MinhaAPI\Column {

    use Autombot\MinhaAPI\Cache\Cache;
    use Autombot\MinhaAPI\Column\Reflection\ReflectedDatabase;
    use Autombot\MinhaAPI\Column\Reflection\ReflectedTable;
    use Autombot\MinhaAPI\Database\GenericDB;
...
// file: src/Autombot/MinhaAPI/Config/Base/ConfigInterface.php
namespace Autombot\MinhaAPI\Config\Base {
...
// file: src/Autombot/MinhaAPI/Config/Config.php
namespace Autombot\MinhaAPI\Config {

    use Autombot\MinhaAPI\Config\Base\ConfigInterface;
...
// file: src/Autombot/MinhaAPI/Controller/CacheController.php
namespace Autombot\MinhaAPI\Controller {

    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Autombot\MinhaAPI\Cache\Cache;
    use Autombot\MinhaAPI\Middleware\Router\Router;
...
// file: src/Autombot/MinhaAPI/Controller/ColumnController.php
namespace Autombot\MinhaAPI\Controller {

    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Autombot\MinhaAPI\Column\DefinitionService;
    use Autombot\MinhaAPI\Column\ReflectionService;
    use Autombot\MinhaAPI\Middleware\Router\Router;
    use Autombot\MinhaAPI\Record\ErrorCode;
    use Autombot\MinhaAPI\RequestUtils;
...
// file: src/Autombot/MinhaAPI/Controller/GeoJsonController.php
namespace Autombot\MinhaAPI\Controller {

    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Autombot\MinhaAPI\GeoJson\GeoJsonService;
    use Autombot\MinhaAPI\Middleware\Router\Router;
    use Autombot\MinhaAPI\Record\ErrorCode;
    use Autombot\MinhaAPI\RequestUtils;
...
// file: src/Autombot/MinhaAPI/Controller/JsonResponder.php
namespace Autombot\MinhaAPI\Controller {

    use Psr\Http\Message\ResponseInterface;
    use Autombot\MinhaAPI\Record\Document\ErrorDocument;
    use Autombot\MinhaAPI\Record\ErrorCode;
    use Autombot\MinhaAPI\ResponseFactory;
    use Autombot\MinhaAPI\ResponseUtils;
...
// file: src/Autombot/MinhaAPI/Controller/OpenApiController.php
namespace Autombot\MinhaAPI\Controller {

    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Autombot\MinhaAPI\Middleware\Router\Router;
    use Autombot\MinhaAPI\OpenApi\OpenApiService;
...
// file: src/Autombot/MinhaAPI/Controller/RecordController.php
namespace Autombot\MinhaAPI\Controller {
    ...
    use Autombot\MinhaAPI\Middleware\Router\Router;
    use Autombot\MinhaAPI\Record\ErrorCode;
    use Autombot\MinhaAPI\Record\RecordService;
    use Autombot\MinhaAPI\RequestUtils;
...
// file: src/Autombot/MinhaAPI/Controller/Responder.php
namespace Autombot\MinhaAPI\Controller {
...
// file: src/Autombot/MinhaAPI/Controller/StatusController.php
namespace Autombot\MinhaAPI\Controller {
...
// file: src/Autombot/MinhaAPI/Database/ColumnConverter.php
namespace Autombot\MinhaAPI\Database {
...
// file: src/Autombot/MinhaAPI/Database/ColumnsBuilder.php
namespace Autombot\MinhaAPI\Database {
...
// file: src/Autombot/MinhaAPI/Database/ConditionsBuilder.php
namespace Autombot\MinhaAPI\Database {

    use Autombot\MinhaAPI\Column\Reflection\ReflectedColumn;
    use Autombot\MinhaAPI\Record\Condition\AndCondition;
    use Autombot\MinhaAPI\Record\Condition\ColumnCondition;
    use Autombot\MinhaAPI\Record\Condition\Condition;
    use Autombot\MinhaAPI\Record\Condition\NoCondition;
    use Autombot\MinhaAPI\Record\Condition\NotCondition;
    use Autombot\MinhaAPI\Record\Condition\OrCondition;
    use Autombot\MinhaAPI\Record\Condition\SpatialCondition;
...
// file: src/Autombot/MinhaAPI/Database/DataConverter.php
namespace Autombot\MinhaAPI\Database {
...
// file: src/Autombot/MinhaAPI/Database/GenericDB.php
namespace Autombot\MinhaAPI\Database {

    use Autombot\MinhaAPI\Column\Reflection\ReflectedTable;
    use Autombot\MinhaAPI\Middleware\Communication\VariableStore;
    use Autombot\MinhaAPI\Record\Condition\ColumnCondition;
    use Autombot\MinhaAPI\Record\Condition\Condition;
...
// file: src/Autombot/MinhaAPI/Database/GenericDefinition.php
namespace Autombot\MinhaAPI\Database {

    use Autombot\MinhaAPI\Column\Reflection\ReflectedColumn;
    use Autombot\MinhaAPI\Column\Reflection\ReflectedTable;
    use Autombot\MinhaAPI\Database\LazyPdo;
...
// file: src/Autombot/MinhaAPI/Database/GenericReflection.php
namespace Autombot\MinhaAPI\Database {
...
// file: src/Autombot/MinhaAPI/Database/LazyPdo.php
namespace Autombot\MinhaAPI\Database {
...
// file: src/Autombot/MinhaAPI/Database/RealNameMapper.php
namespace Autombot\MinhaAPI\Database {
...
// file: src/Autombot/MinhaAPI/Database/TypeConverter.php
namespace Autombot\MinhaAPI\Database {
...
// file: src/Autombot/MinhaAPI/GeoJson/Feature.php
namespace Autombot\MinhaAPI\GeoJson {
...
// file: src/Autombot/MinhaAPI/GeoJson/FeatureCollection.php
namespace Autombot\MinhaAPI\GeoJson {
...
// file: src/Autombot/MinhaAPI/GeoJson/GeoJsonService.php
namespace Autombot\MinhaAPI\GeoJson {

    use Autombot\MinhaAPI\Column\ReflectionService;
    use Autombot\MinhaAPI\GeoJson\FeatureCollection;
    use Autombot\MinhaAPI\Record\RecordService;
...
// file: src/Autombot/MinhaAPI/GeoJson/Geometry.php
namespace Autombot\MinhaAPI\GeoJson {
...
// file: src/Autombot/MinhaAPI/Middleware/Base/Middleware.php
namespace Autombot\MinhaAPI\Middleware\Base {

    use Psr\Http\Server\MiddlewareInterface;
    use Autombot\MinhaAPI\Controller\Responder;
    use Autombot\MinhaAPI\Middleware\Router\Router;
    use Autombot\MinhaAPI\Config\Base\ConfigInterface;
...
// file: src/Autombot/MinhaAPI/Middleware/Communication/VariableStore.php
namespace Autombot\MinhaAPI\Middleware\Communication {
...
// file: src/Autombot/MinhaAPI/Middleware/Router/Router.php
namespace Autombot\MinhaAPI\Middleware\Router {

    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Psr\Http\Server\RequestHandlerInterface;
    use Autombot\MinhaAPI\Middleware\Base\Middleware;
...
// file: src/Autombot/MinhaAPI/Middleware/Router/SimpleRouter.php
namespace Autombot\MinhaAPI\Middleware\Router {
    ...
    use Autombot\MinhaAPI\Middleware\Base\Middleware;
    use Autombot\MinhaAPI\Record\ErrorCode;
    use Autombot\MinhaAPI\Record\PathTree;
    use Autombot\MinhaAPI\RequestUtils;
...
// file: src/Autombot/MinhaAPI/Middleware/AjaxOnlyMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/ApiKeyAuthMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/ApiKeyDbAuthMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
    ...
    use Psr\Http\Server\RequestHandlerInterface;
    use Autombot\MinhaAPI\Column\ReflectionService;
    use Autombot\MinhaAPI\Config\Config;
    use Autombot\MinhaAPI\Controller\Responder;
    use Autombot\MinhaAPI\Database\GenericDB;
    use Autombot\MinhaAPI\Middleware\Base\Middleware;
    use Autombot\MinhaAPI\Middleware\Router\Router;
    use Autombot\MinhaAPI\Record\Condition\ColumnCondition;
    use Autombot\MinhaAPI\Record\ErrorCode;
    use Autombot\MinhaAPI\Record\OrderingInfo;
    use Autombot\MinhaAPI\RequestUtils;
...
// file: src/Autombot/MinhaAPI/Middleware/AuthorizationMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
    ...
    use Autombot\MinhaAPI\Middleware\Router\Router;
    use Autombot\MinhaAPI\Record\ErrorCode;
    use Autombot\MinhaAPI\Record\FilterInfo;
    use Autombot\MinhaAPI\RequestUtils;
...
// file: src/Autombot/MinhaAPI/Middleware/BasicAuthMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/CorsMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/CustomizationMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/DbAuthMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/FirewallMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/IpAddressMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/JoinLimitsMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/JsonMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/JwtAuthMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/MultiTenancyMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/PageLimitsMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/ReconnectMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/SanitationMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/SslRedirectMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/TextSearchMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/ValidationMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/WpAuthMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/XmlMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/Middleware/XsrfMiddleware.php
namespace Autombot\MinhaAPI\Middleware {
...
// file: src/Autombot/MinhaAPI/OpenApi/OpenApiBuilder.php
namespace Autombot\MinhaAPI\OpenApi {

    use Psr\Http\Message\ServerRequestInterface;
    use Autombot\MinhaAPI\Column\ReflectionService;
    use Autombot\MinhaAPI\OpenApi\OpenApiDefinition;
...
// file: src/Autombot/MinhaAPI/OpenApi/OpenApiColumnsBuilder.php
namespace Autombot\MinhaAPI\OpenApi {
...
// file: src/Autombot/MinhaAPI/OpenApi/OpenApiDefinition.php
namespace Autombot\MinhaAPI\OpenApi {
...
// file: src/Autombot/MinhaAPI/OpenApi/OpenApiRecordsBuilder.php
namespace Autombot\MinhaAPI\OpenApi {
...
// file: src/Autombot/MinhaAPI/OpenApi/OpenApiService.php
namespace Autombot\MinhaAPI\OpenApi {

    use Psr\Http\Message\ServerRequestInterface;
    use Autombot\MinhaAPI\Column\ReflectionService;
    use Autombot\MinhaAPI\OpenApi\OpenApiBuilder;
    use Autombot\MinhaAPI\RequestFactory;
...
// file: src/Autombot/MinhaAPI/OpenApi/OpenApiStatusBuilder.php
namespace Autombot\MinhaAPI\OpenApi {
...
// file: src/Autombot/MinhaAPI/Record/Condition/AndCondition.php
namespace Autombot\MinhaAPI\Record\Condition {
...
// file: src/Autombot/MinhaAPI/Record/Condition/ColumnCondition.php
namespace Autombot\MinhaAPI\Record\Condition {
...
// file: src/Autombot/MinhaAPI/Record/Condition/Condition.php
namespace Autombot\MinhaAPI\Record\Condition {
...
// file: src/Autombot/MinhaAPI/Record/Condition/NoCondition.php
namespace Autombot\MinhaAPI\Record\Condition {
...
// file: src/Autombot/MinhaAPI/Record/Condition/NotCondition.php
namespace Autombot\MinhaAPI\Record\Condition {
...
// file: src/Autombot/MinhaAPI/Record/Condition/OrCondition.php
namespace Autombot\MinhaAPI\Record\Condition {
...
// file: src/Autombot/MinhaAPI/Record/Condition/SpatialCondition.php
namespace Autombot\MinhaAPI\Record\Condition {
...
// file: src/Autombot/MinhaAPI/Record/Document/ErrorDocument.php
namespace Autombot\MinhaAPI\Record\Document {
...
// file: src/Autombot/MinhaAPI/Record/Document/ListDocument.php
namespace Autombot\MinhaAPI\Record\Document {
...
// file: src/Autombot/MinhaAPI/Record/ColumnIncluder.php
namespace Autombot\MinhaAPI\Record {
...
// file: src/Autombot/MinhaAPI/Record/ErrorCode.php
namespace Autombot\MinhaAPI\Record {
...
// file: src/Autombot/MinhaAPI/Record/FilterInfo.php
namespace Autombot\MinhaAPI\Record {
...
// file: src/Autombot/MinhaAPI/Record/HabtmValues.php
namespace Autombot\MinhaAPI\Record {
...
// file: src/Autombot/MinhaAPI/Record/OrderingInfo.php
namespace Autombot\MinhaAPI\Record {
...
// file: src/Autombot/MinhaAPI/Record/PaginationInfo.php
namespace Autombot\MinhaAPI\Record {
...
// file: src/Autombot/MinhaAPI/Record/PathTree.php
namespace Autombot\MinhaAPI\Record {
...
namespace Autombot\MinhaAPI\Record {
    ...
    use Autombot\MinhaAPI\Column\ReflectionService;
    use Autombot\MinhaAPI\Database\GenericDB;
    use Autombot\MinhaAPI\Record\Document\ListDocument;
...
namespace Autombot\MinhaAPI {

    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Psr\Http\Server\RequestHandlerInterface;
    use Autombot\MinhaAPI\Cache\CacheFactory;
    use Autombot\MinhaAPI\Column\DefinitionService;
    use Autombot\MinhaAPI\Column\ReflectionService;
    use Autombot\MinhaAPI\Config\Config;
    use Autombot\MinhaAPI\Controller\CacheController;
    use Autombot\MinhaAPI\Controller\ColumnController;
    use Autombot\MinhaAPI\Controller\GeoJsonController;
    use Autombot\MinhaAPI\Controller\JsonResponder;
    use Autombot\MinhaAPI\Controller\OpenApiController;
    use Autombot\MinhaAPI\Controller\RecordController;
    use Autombot\MinhaAPI\Controller\StatusController;
    use Autombot\MinhaAPI\Database\GenericDB;
    use Autombot\MinhaAPI\GeoJson\GeoJsonService;
    use Autombot\MinhaAPI\Middleware\ApiKeyAuthMiddleware;
    use Autombot\MinhaAPI\Middleware\ApiKeyDbAuthMiddleware;
    use Autombot\MinhaAPI\Middleware\AuthorizationMiddleware;
    use Autombot\MinhaAPI\Middleware\BasicAuthMiddleware;
    use Autombot\MinhaAPI\Middleware\CorsMiddleware;
    use Autombot\MinhaAPI\Middleware\CustomizationMiddleware;
    use Autombot\MinhaAPI\Middleware\DbAuthMiddleware;
    use Autombot\MinhaAPI\Middleware\FirewallMiddleware;
    use Autombot\MinhaAPI\Middleware\IpAddressMiddleware;
    use Autombot\MinhaAPI\Middleware\JoinLimitsMiddleware;
    use Autombot\MinhaAPI\Middleware\JsonMiddleware;
    use Autombot\MinhaAPI\Middleware\JwtAuthMiddleware;
    use Autombot\MinhaAPI\Middleware\MultiTenancyMiddleware;
    use Autombot\MinhaAPI\Middleware\PageLimitsMiddleware;
    use Autombot\MinhaAPI\Middleware\ReconnectMiddleware;
    use Autombot\MinhaAPI\Middleware\Router\SimpleRouter;
    use Autombot\MinhaAPI\Middleware\SanitationMiddleware;
    use Autombot\MinhaAPI\Middleware\SslRedirectMiddleware;
    use Autombot\MinhaAPI\Middleware\TextSearchMiddleware;
    use Autombot\MinhaAPI\Middleware\ValidationMiddleware;
    use Autombot\MinhaAPI\Middleware\WpAuthMiddleware;
    use Autombot\MinhaAPI\Middleware\XmlMiddleware;
    use Autombot\MinhaAPI\Middleware\XsrfMiddleware;
    use Autombot\MinhaAPI\OpenApi\OpenApiService;
    use Autombot\MinhaAPI\Record\RecordService;
    ...
    class Api implements RequestHandlerInterface
    {
        ...
        public function __construct(Config $config)
        {
            ...
            $prefix = sprintf('MinhaAPI-%s-', substr(md5(__FILE__), 0, 8));
...
namespace Autombot\MinhaAPI {
    ...
    $config = new Config([
        ...
        'address' => 'localhost',
        'port' => '3306',
        'username' => 'u929696492_autombot',
        'password' => 'Gvt@946894334',
        'database' => 'u929696492_autombot',
        'debug' => true,
        'middlewares' => 'apiKeyAuth',
        'apiKeyAuth.keys' => 'fyt9dk451NPrJT2', // Substitua com sua chave de API - Gerador >> (https://codebeautify.org/generate-random-hexadecimal-numbers)
    ]);
